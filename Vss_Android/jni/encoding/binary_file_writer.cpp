...
bool BinaryFileWriter::open(string file_name) {
	...
	if (file == NULL) {
		...
		LOGE("Cannot open file %s for writing", file_name.c_str());
		opened = false;
		return false;
	}
...
bool BinaryFileWriter::write_unary(int number) {
	...
	if (number <= 0) {
		cerr
				<< "Unary coding only works for positive integer, cannot work for number = "
				<< number << endl;
		LOGE(
				"Unary coding only works for positive integer, cannot work for number = %d",
				number);
		return false;
	}
...
bool BinaryFileWriter::write_gamma(int number) {
	...
	if (number <= 0) {
		cerr
				<< "Gamma coding only works for positive integer, cannot work for number = "
				<< number << endl;
		LOGE(
				"Gamma coding only works for positive integer, cannot work for number = %d",
				number);
		return false;
	}
...
bool BinaryFileWriter::write_delta(int number) {
	...
	if (number <= 0) {
		cerr
				<< "Delta coding only works for positive integer, cannot work for number = "
				<< number << endl;
		LOGE(
				"Delta coding only works for positive integer, cannot work for number = %d",
				number);
		return false;
	}
...
bool BinaryFileWriter::write_omega(int number) {
	...
	if (number <= 0) {
		cerr
				<< "Omega coding only works for positive integer, cannot work for number = "
				<< number << endl;
		LOGE(
				"Omega coding only works for positive integer, cannot work for number = %d",
				number);
		return false;
	}
